...
namespace Illuminate\Http {
     ...
     *
     *
     *@property mixed $species*@property mixed $birth_day*@property mixed $gender*@property mixed $neutered*@property mixed $chip*@property mixed $breed*@property mixed $weight*/        class Request {public mixed $name;
                    /**
         *
         *
         * @see \Illuminate\Foundation\Providers\FoundationServiceProvider::registerRequestValidation()
